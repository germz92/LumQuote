...
function wrapEmailHtml({ title, bodyHtml, ctaLabel, ctaUrl, footer }) {
  const button = ctaUrl && ctaLabel
    ? `<p style="margin:24px 0"><a href="${ctaUrl}" style="display:inline-block;padding:12px 18px;background:#1f2430;color:#fff;text-decoration:none;border-radius:6px;font-weight:600">${ctaLabel}</a></p>`
    : '';
